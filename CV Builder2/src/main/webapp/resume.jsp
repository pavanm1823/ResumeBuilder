...
<html>
    ...
    <body>
        ...
        <section id="about-sc" class="">
            <div class="container">
                <div class="about-cnt">
                    <form action="submit.jsp" method="post" class="cv-form" id="cv-form">
                        ...
                        <input type="submit" class = "print-btn btn btn-primary" onclick="saveCV()">
                    </form>
                 </div>
            </div>
        </section>
    ...
    <script>
    function saveCV() {
        var formData = new FormData($('#cv-form')[0]);

        $.ajax({
            url: 'submit.jsp', // URL to your JSP file handling the form submission
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            error: function(xhr, status, error) {
                ...
                alert('Error occurred while saving CV');
            }
        });
    }
    </script>
